...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Categorias -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.areas.index') }}"><i class="fas fa-list-ul"></i><span>Áreas de Atuação</span></a>
            </li>

            <!-- Nav Item - Categorias -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.galerias.index') }}"><i class="far fa-images"></i><span>Galeria</span></a>
            </li>

            <!-- Nav Item - Categorias -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.parceiros.index') }}"><i class="fas fa-users"></i><span>Parceiros</span></a>
            </li>
